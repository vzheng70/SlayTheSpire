public class Player{
  ...
  public void drawStatuses(int x,int y){
    ...
    textSize(10);
    if(strength>0){
      //image(loadImage("../images/Strength.png"),x+offset,y+200,20,20);
      text(strength,x+offset+20,y+240);
      offset+=20;
    }if(dexterity>0){
      //image(loadImage("../images/Dexterity.png"),x+offset,y+200,20,20);
      text(dexterity,x+offset+20,y+240);
      offset+=20;
    }if(infiniteBlades>0){
      //image(loadImage("../images/Infinite_Blade_Icon.png"),x+offset,y+200,20,20);
      text(infiniteBlades,x+offset+20,y+240);
      offset+=20;
    }if(accuracy>0){
      //image(loadImage("../images/Accuracy_Icon.png"),x+offset,y+200,20,20);
      text(accuracy,x+offset+20,y+240);
      offset+=20;
    }if(noxiousFumes>0){
      //image(loadImage("../images/Noxious_Fumes_Icon.png"),x+offset,y+200,20,20);
      text(noxiousFumes,x+offset+20,y+240);
      offset+=20;
    }
    if(vulnerable>0){
      image(loadImage("../images/Vulnerable.png"),x+offset,y+200,20,20);
      text(vulnerable,x+offset+20,y+240);
      offset+=20;
    }if(weak>0){
      image(loadImage("../images/Weak.png"),x+offset,y+200,20,20);
      text(weak,x+offset+20,y+240);
      offset+=20;
    }if(frail>0){
      //image(loadImage("../images/Frail.png"),x+offset,y+200,20,20);
